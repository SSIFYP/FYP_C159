...
# This is for performing calibration using IMU only

file_path = "/home/ssi/IMU_Calibration_Data.txt"
...
with open(file_path, "w") as file:
    file.write(f"ax: {ax_OS}\n")
    file.write(f"ay: {ay_OS}\n")
    file.write(f"az: {az_OS}\n")
    file.write(f"gx: {gx_OS}\n")
    file.write(f"gy: {gy_OS}\n")
    file.write(f"gz: {gz_OS}\n")
print("Offeset Added : ")       
print ("ax :", ax_OS)
print ("ay :",ay_OS)
print ("az :",az_OS)
